...
const DocumentoSchema = new Schema<DocumentoDocument>(
  {
    ...
    categoria: {
      type: String,
      enum: [
        'identidade', 'cpf', 'comprovante_residencia', 'contrato',
        'planta', 'laudo_tecnico', 'memorial_descritivo', 'levantamento_topografico',
        'certidao_negativa', 'alvara', 'habite_se',
        'matricula', 'iptu', 'escritura',
        'outros',
      ],
      default: 'outros',
    },
    etapa: {
      type: String,
      enum: ['cadastro', 'engenharia', 'aprovacao', 'cartorio', 'outros'],
      default: 'outros',
    },
    nota:           { type: String },
    data:           { type: String },
